...
if(document.querySelector("#all-recepies-nav")) {
  document.querySelector("#all-recepies-nav").innerHTML = 
  `<nav class="navbar navbar-expand-md navbar-light bg-light">
  <a href="home.html" class="navbar-brand"><img src="images/400-4002708_chef-hat-clip-art-chef-hat-svg-free.jpg"
      width="30" height="30" class="d-inline-block align-top" alt=""></a>
  <button type="button" class="navbar-toggler bg-light" data-toggle="collapse" data-target="#nav">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-collapse justify-content-between" id="nav">
    ...
    <form class="form-inline ml-3">
      <div class="input-group">
        <input oninput="searchRecepie()" id="search" class="form-control" type="search" placeholder="Search"
          aria-label="Search">
      </div>
    </form>
  </div>
